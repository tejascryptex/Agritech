...
class CropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crop" do
    assert_difference("Crop.count") do
      post crops_url, params: { crop: { description: @crop.description, name: @crop.name, user_id: @crop.user_id } }
    end
  ...
  test "should update crop" do
    patch crop_url(@crop), params: { crop: { description: @crop.description, name: @crop.name, user_id: @crop.user_id } }
